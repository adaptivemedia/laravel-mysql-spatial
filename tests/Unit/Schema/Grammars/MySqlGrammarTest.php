...
class MySqlGrammarTest extends BaseTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->connection = new MysqlConnection(new PDOStub());
        $this->connection->setSchemaGrammar(new MySqlGrammar($this->connection));
    }

    public function testAddingGeometry()
    {
        $blueprint = new Blueprint($this->connection, 'test');
    ...
    public function testAddRemoveSpatialIndex()
    {
        ...
        $dropStatements = $blueprint->toSql();
